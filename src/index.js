...
function renderList() {
    ...
    for (const note of toDoList.noteList) {
...
form.addEventListener('submit', (e) => {
    ...
    if (formTitle && formText) {
        toDoList.addNote(formTitle, formText);
    }
    e.target.reset();
